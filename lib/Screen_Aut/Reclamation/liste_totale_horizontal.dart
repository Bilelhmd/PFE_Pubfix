...
class DetailRapportHorizontalAut extends StatefulWidget {
  const DetailRapportHorizontalAut({super.key});

  @override
  _DetailRapportHorizontalAutState createState() =>
      _DetailRapportHorizontalAutState();
}

class _DetailRapportHorizontalAutState
    extends State<DetailRapportHorizontalAut> {
        ...
        children: <Widget>[
          Expanded(
            child: ListView.builder(
              ...
              itemCount: _reclamations.length >= 5 ? 5 : _reclamations.length,
              itemBuilder: (context, index) {
                final demande = _reclamations[index];
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: ListTile(
                              onTap: () {
                                _adresseController.text = demande.localisation;
                                searchAndMarkAddress(demande.localisation,
                              ...
                              trailing: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: demande.statut == 'En attente'
                                      ? Colors.green
