...
class DetailRapportHorizontal extends StatefulWidget {
  const DetailRapportHorizontal({super.key});

  @override
  _DetailRapportHorizontalState createState() =>
      _DetailRapportHorizontalState();
}

class _DetailRapportHorizontalState extends State<DetailRapportHorizontal> {
