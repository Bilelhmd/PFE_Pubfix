...
class ListeOuvert extends StatefulWidget {
  const ListeOuvert({super.key});

  @override
  _ListeOuvertState createState() => _ListeOuvertState();
}

class _ListeOuvertState extends State<ListeOuvert> {
  ...
  void getDemandesData() async {
    List<DemandeModel> responseList =
        await _firestoreService.getDemandesbyStatusOuvert();
