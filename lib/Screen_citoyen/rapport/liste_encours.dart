...
class ListeEnCours extends StatefulWidget {
  const ListeEnCours({super.key});

  @override
  _ListeEnCoursState createState() => _ListeEnCoursState();
}

class _ListeEnCoursState extends State<ListeEnCours> {
  ...
  void getDemandesData() async {
    List<DemandeModel> responseList =
        await _firestoreService.getDemandesbyStatusEncours();
