...
class ListeFerme extends StatefulWidget {
  const ListeFerme({super.key});

  @override
  _ListeFermeState createState() => _ListeFermeState();
}

class _ListeFermeState extends State<ListeFerme> {
  ...
  List<DemandeModel> itemsData = [];
  final FirestoreService _firestoreService = FirestoreService();

  void getDemandesData() async {
    List<DemandeModel> responseList =
        await _firestoreService.getDemandesbyStatusFerme();
                                      ...
                                      child: ListTile(
                                                                      ...
                                                                      children: <Widget>[
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            demande.date != null
                                                                                ? authVM.formatDate(authVM.timestampToDateTime(timestamp))
                                                                                : "",
                                                                            style:
                                                                                const TextStyle(
                                                                              fontFamily: 'Roboto',
                                        ...
                                        /*       trailing: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            color: demande.status == 'Ouvert'
                                                ? Colors.green
                                                : demande.status == 'Fermé'
                                                    ? Colors.red
                                                    : Colors.blue,
                                            boxShadow: [
                                              BoxShadow(
