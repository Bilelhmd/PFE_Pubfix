...
class ListeActualiteHorizontal extends StatefulWidget {
  const ListeActualiteHorizontal({super.key});

  @override
  _ListeActualiteHorizontalState createState() =>
      _ListeActualiteHorizontalState();
}

class _ListeActualiteHorizontalState extends State<ListeActualiteHorizontal> {
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              TextFormField(
                                                                                ...
                                                                                decoration: const InputDecoration(border: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(50))), prefixIcon: Icon(Icons.email_rounded), labelText: "Email", hintText: "Tapez votre Email"),
                                                                              ),
                                                                              const SizedBox(
                                                                                height: 5,
                                                                              ),
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Column(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  const Text("Réinitialisation avec N° téléphone")
                                                                                ],
                                                                              )
                                                                            ],
                                                                          ),
