...
class ListeEvenementHorizontal extends StatefulWidget {
  const ListeEvenementHorizontal({super.key});

  @override
  _ListeEvenementHorizontalState createState() =>
      _ListeEvenementHorizontalState();
}

class _ListeEvenementHorizontalState extends State<ListeEvenementHorizontal> {
  ...
  void getEvenementsData() async {
    List<Evenement> responseList = await EvenVM.getEvenement();
                                                                    ...
                                                                    children: <Widget>[
                                                                      ...
                                                                      Expanded(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          evenement.date != null
                                                                              ? _evenementViewModel.formatDate(_evenementViewModel.timestampToDateTime(timestamp))
                                                                              : "",
                                                                          style:
                                                                              const TextStyle(
                                                                            fontFamily:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        Navigator
                                                                          ...
                                                                          MaterialPageRoute(
                                                                            builder: (context) =>
                                                                                ImageZoomPage(imageUrl: evenement.image),
                                                                          ),
                                                                        );
                                                                      },
                                                                      child:
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        title: const Text(
                                                                            "Confirmation"),
                                                                        content:
                                                                            const Text("Voulez-vous vraiment supprimer cette evenement ?"),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed:
                                                                                () {
